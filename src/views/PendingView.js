  ...
  container.innerHTML = `
    <div class="min-h-screen bg-surface flex flex-col items-center justify-center p-4">
      <div class="bg-white p-8 md:p-10 rounded-3xl shadow-soft text-center max-w-md w-full border border-slate-100">
        ...
        <h2 class="text-2xl md:text-3xl font-display font-bold text-slate-800 mb-3">Aguardando Aprovação</h2>
        <p class="text-slate-600 mb-8">
          Sua conta foi criada com sucesso, mas o administrador ainda precisa liberar o seu acesso como vendedor. 
          Por favor, aguarde a aprovação ou entre em contato com a gerência.
        </p>
